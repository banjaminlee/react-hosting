...
function Navbar() {
  ...
  return (
    <nav className={` fixed w-full  px-12 flex justify-between items-center md:px-24 ${navBg?"py-7 bg-color-bg-black":"py-10 bg-transparent transition-all duration-500"}`}>
      <div className="logo">
        <img src={logo} alt="22N logo" className="lg:hidden max-w-[70%]" />
        <img src={bigLogo} alt="22N Logo" className="hidden lg:block max-w-[70%]" />
      </div>
